...
output_folder = '/scratch/vgross/upscaling_results_mito_new_gt/'
...
input_raw_file = '/scratch/vgross/amst_inv_clip_black_bg.h5'
#nput_mem_file = '/g/emcf/common/5792_Sars-Cov-2/Exp_070420/FIB-SEM/segmentation/upscale/20-04-23_S4_area2_Sam/mem_pred_scale1.h5'
input_mem_file = '/scratch/vgross/mem_pred_scale1.h5'
...
run_whole_process(output_folder = output_folder,
                  ...
                  n_threads = 16, beta = 0.6, result_pattern='mc_{}_{}_{}.h5', segm_cube_size = (1024, 1024, 1024),
                  segm_overlap=(256, 256, 256), segm_block_size=[512, 512, 512], segm_start_index = (0,0,0), segm_end_index = None,
                  need_stitching_results = True, result_filename_stitched = 'result_file_stitching_final.h5')