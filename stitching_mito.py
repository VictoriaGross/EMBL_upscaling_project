...
#res_path = '/scratch/vgross/upscaling_results_mito/'
...
#@profile
def stitching_row(start_index=(0, 0, 0), row_count=0, step=512, total_shape=(1024, 2304, 1792), maxlabel=maxlabel, axis=2,
                  use_stitched=False):
    ...
    current_shape = (0, 0, 0)
    while not end:
        filename_results = 's4a2_mc_' + str(z) + '_' + str(y) + '_' + str(
            x) + '_' + '1024_1024_1024.h5'  # str(size_cube) + '_' + str(size_cube) + '_' + str(size_cube) + '.h5'
...
def stitching_column_by_rows(z = 0, column_index = 0, shapes_of_rows = [(1024, 1024, 1024)], maxlabel = 0, start_row_index = 0, end_row_index = 1, step_z = 768, step_y = 768, step_x = 768, total_shape=(1024, 2304, 1792)):
    y = 0
    x = 0
    current_shape = (0, 0, 0)
...
current_shape, maxlabel = stitch_total(step_x=768, step_y=768, step_z=768, maxlabel=0, total_shape=shape, n_workers=8)
